...
Criar um programa em JavaScript com switch case a média final de um aluno e informe sua situação no final do ano.


📌 Regras do programa
1. O programa deve receber 4 notas (de 0 a 10).
2. Calcular a média das notasb .
...
console.log(media(10, 4, 10, 4));

// MANEIRA DE RESOLUÇÃO CASTELLO.
